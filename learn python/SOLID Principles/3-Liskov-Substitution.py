...
'''
In this example, we have three classes: Notification, Email, and SMS. The Email and SMS classes inherit 
...
However, the SMS class uses a phone number, not an email, for sending a message. Therefore, we need to 
change the signature of the notify() method of the SMS class to accept a phone number instead of an email.
'''
...
'''
The send() method of the NoticationManager class accepts a notification object. It checks whether the 
notification is an instance of the Email or SMS and passes the email and phone of contact to the notify() 
method respectively.
'''
...
Liskov substitution principle aims to ensure that the child class can assume the place of its parent class 
